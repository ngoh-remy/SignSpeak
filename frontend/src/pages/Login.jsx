      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        <div className="glass-card" style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '0.85rem', marginBottom: '24px', textAlign: 'center' }}>
            {lang === 'fr'
              ? 'Connectez-vous pour accéder à vos traductions.'
              : 'Sign in to continue tracking your translations.'}
          </p>
          ...
          <p style={{ fontSize: '0.85rem', color: '#64748b', marginTop: '20px', textAlign: 'center' }}>
            {lang === 'fr' ? "Pas encore de compte ?" : "New here?"}{' '}
            <span style={{ color: '#8b5cf6', cursor: 'pointer' }} onClick={() => navigate('/signup')}>
              {t.signUpBtn}
            </span>
          </p>
        </div>
